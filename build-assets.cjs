...
const mappings = {
  'hero_main_1787339727168.png': { targetFolder: 'hero', name: 'hero-main' },
  ...
  'store_02_1787340399617.png': { targetFolder: 'store', name: 'store-02' },
...
const collectionCategoryMappings = [
  ...
  { src: 'hero_suits_1787340357714.png', name: 'suits-01' },
